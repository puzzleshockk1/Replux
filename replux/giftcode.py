    ...
    def main(self):  # The main function contains the most important code
        ...
        if os.name == "nt":  # If the system is windows
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Credits: Discord nitro generator is made by open source"
            )  # Change the
        else:  # Or if it is unix
            print(f'\33]0;Gen\a', end='',
        ...
        self.slowType(
            "Credits: Discord nitro generator is made by open source", .02)
        ...
        for s in c:  # Loop over the amount of codes to check
            ...
            if os.name == "nt":  # If the system is windows
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Generator is made by opensource"
                )  # Change the title
                print("")
            else:  # If it is a unix system
                # Change the title
                print(
                    f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - Generator is made by opensource\a',
                    end='',
                    flush=True)
